...
export const masterDataService = {
  ...
  getPostalCodes: () => [
    ...
    getWorkOrders: () => [
    { id: 1, woNo: "WO-2025-001", description: "Mining Site Inspection", createDate: "2025-01-15", status: "Active" },
    { id: 2, woNo: "WO-2025-002", description: "Equipment Maintenance", createDate: "2025-01-20", status: "Active" },
  ],
  
  getWODetails: () => [
    { id: 1, woNo: "WO-2025-001", detailNo: "DTL-001", taskDescription: "Site Survey", assignedTo: "John Doe", startDate: "2025-01-16", endDate: "2025-01-18", status: "Active" },
  ],

  getComplaints: () => [
  { id: 1, customer: "Maga Engineering (Pvt) Ltd", date: "2025-01-15", woNo: "WO-2025-001", complaint: "Equipment malfunction", status: "Pending" },
],
}
