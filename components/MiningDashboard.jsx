...
import WOMaster from "./master-data/WOMaster";
import WODetailMaster from "./master-data/WODetailMaster";
import ComplaintMaster from "./master-data/ComplaintMaster";
      ...
      submenu: [
        {
          ...
          submenu: [
            ...
            { label: "Tax Type", href: "#", view: "tax-type-master" },
            {
              ...
              href: "#",
              view: "attachment-type-master",
            },
            { label: "Status", href: "#", view: "status-master" },
            { label: "Work Order", href: "#", view: "wo-master" },
            { label: "Work Order Detail", href: "#", view: "wo-detail-master" },
            { label: "Complaint Master", href: "#", view: "complaint-master" },
          ],
        },
      ],
    },
  ...
  const renderCurrentView = () => {
    switch (currentView) {
      ...
      case "client-management":
        return (
          <ClientManagement
            onNewClient={() => setCurrentView("client-registration")}
          />
        );
      case "client-registration":
        return (
          <ClientRegistration
            onBack={() => setCurrentView("client-management")}
          />
        );
      case "application-management":
        return (
          <ApplicationManagement
            onNewApplication={() => setCurrentView("application-registration")}
          />
        );
      case "application-registration":
        return (
          <ApplicationRegistration
            onBack={() => setCurrentView("application-management")}
          />
        );
      ...
      case "wo-master":
        return <WOMaster />;
      case "wo-detail-master":
        return <WODetailMaster />;
          ...
          >
            ...
            <div className="p-4 border-b border-border">
              <div className="flex items-center justify-between">
                {sidebarOpen && (
                  <h2 className="text-xl font-bold text-foreground">Mining</h2>
                )}
                <Button
                  variant="ghost"
                  size="sm"
                  ...
                  <div key={index}>
                    <div className="relative">
                      <Button
                        ...
                        className={`w-full ${
                          !sidebarOpen ? "justify-center px-2" : "justify-start"
                        } ${
                          item.active
                            ...
                            subItem.isHeader ? (
                              ...
                              <div key={subIndex}>
                                <Button
                                  ...
                                  onClick={() =>
                                    setMasterItemsOpen(!masterItemsOpen)
                                  }
                                >
            ...
            <div className="p-2 border-t border-border">
              <div className="relative">
                <Button
                  ...
                  onMouseEnter={(e) =>
                    handleMouseEnter({ label: "Settings" }, e)
                  }
                  onMouseLeave={handleMouseLeave}
                >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                      ...
                      >
                        ...
                        >
                          <div
                            className={`w-4 h-4 bg-background rounded-full absolute top-0.5 transition-transform ${
                              theme === "dark"
                                ? "translate-x-5"
                                : "translate-x-0.5"
